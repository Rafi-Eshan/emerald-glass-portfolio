  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        glass:
          "bg-[hsl(178_30%_15%_/_0.6)] backdrop-blur-xl text-foreground hover:bg-[hsl(176_40%_40%_/_0.3)] border border-[hsl(176_40%_40%_/_0.2)]",
        accent:
          "bg-accent text-accent-foreground shadow-lg hover:shadow-xl hover:scale-105",
        hero:
          "bg-gradient-to-r from-primary to-accent text-primary-foreground shadow-xl hover:shadow-2xl hover:scale-105 font-semibold",
      },
      size: {
